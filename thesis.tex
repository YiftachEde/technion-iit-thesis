...
%
% Additionally, you must specify the degree for which you're writinfg
% your thesis (MSc/PhD/MArch etc.)
%
\documentclass[PhD,with-ethics-statement,noabbrevs,beforeDefense]{misc/iitthesis}
\usepackage{multirow}
\usepackage{float}      
\newglossary[nlg]{notation}{not}{ntn}{Notation}
% allow [H] placement for figures
\usepackage[section]{placeins} % \FloatBarrier after sections
\newcommand{\ourname}{Sharp-It}
\usepackage{graphicx}   % already present in almost every template
\usepackage{multirow}
\usepackage{makecell}   
\newlength{\shift}   \setlength{\shift}{-0.06\textwidth} % left-shift amount
\newlength{\imgW}    \setlength{\imgW}{0.095\textwidth} % width of each thumbnail % gives nice line-breaking inside boxes

% One-line macro for rotated, line-breaking labels
\newcommand{\rotlabel}[2][3cm]{% 1st arg = width before rotation
